...
def img_input(amount):
    ...
    for atr in range(amount):
        ...
        y_train_classify_output.append(y_train_classify_input[atr])
    ...
    for ate in range(test_amount):
        ...
        y_test_classify_output.append(y_test_classify_input[ate])
...
print(len(x_train))
print(len(x_train_shuffle))
print(len(y_train_classify))
print(len(y_train_shuffle))
print(len(x_test))
print(len(x_test_shuffle))
print(len(y_test_classify))
print(len(y_test_shuffle))
