...
def img_input(amount):
    ...
    for a in range(amount):
        ...
        x_train_cropped = crop_centered(x_train_input[a])
    ...
    for b in range(amount // 5):
        ...
        x_test_cropped = crop_centered(x_test_input[b])
...
x_train, x_train_shuffle, y_train_classify, y_train_shuffle, x_test, x_test_shuffle, y_test_classify, y_test_shuffle = img_input(2)
